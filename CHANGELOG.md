...
## [1.1.0](https://github.com/EPFL-ENAC/leure-speed-to-zero/compare/v1.0.0...v1.1.0) (2026-01-26)
...
* **frontend:** Add EmptyState component for improved user feedback in SectorTab ([94b03e6](https://github.com/EPFL-ENAC/leure-speed-to-zero/commit/94b03e6e44171763fe7f4754e8e63dc5051fb425))
...
* **lever:** add loading state and success feedback to LeverSelector and LeversColumnHeader components ([3511546](https://github.com/EPFL-ENAC/leure-speed-to-zero/commit/3511546833bd479e666e41725ff81e0588c220d8))
...
* **linting:** Enhance linter and formatter commands for frontend and backend ([a97b05b](https://github.com/EPFL-ENAC/leure-speed-to-zero/commit/a97b05be6f3bceabbe5aa38aec8aadd2189a1d47))
...
* **sectors:** Enhance sector management with backend integration and frontend updates ([4edfcc9](https://github.com/EPFL-ENAC/leure-speed-to-zero/commit/4edfcc9afa4edf6815de73eea66165fcc169d160))
...
* **setup:** update installation process and enhance git hooks configuration ([48414f6](https://github.com/EPFL-ENAC/leure-speed-to-zero/commit/48414f6d5940f36fd23ec9db359e9a688f385cd3))
...
* **api:** add deleted endpoint for lever data retrieval with sector and country filtering ([b652b70](https://github.com/EPFL-ENAC/leure-speed-to-zero/commit/b652b70ec44921f6ecfc8557c22240ffe45a7e78))
...
* **dependencies:** Add black and flake8 for development and update uv.lock ([a104535](https://github.com/EPFL-ENAC/leure-speed-to-zero/commit/a1045358f2598d4dc3519379f0a969a3f6de1e63))
* **flags:** update Switzerland and Vaud flag SVGs for correct dimensions and styling ([10f7225](https://github.com/EPFL-ENAC/leure-speed-to-zero/commit/10f722520187006d7a86b0434c23604a0d10ab1e))
...
* **model:** Refactor sector configurations and enhance model run functions with type hints and improved logging ([f2aeae7](https://github.com/EPFL-ENAC/leure-speed-to-zero/commit/f2aeae7d487c2dbd4550a116cfbc000f6b783ece))
