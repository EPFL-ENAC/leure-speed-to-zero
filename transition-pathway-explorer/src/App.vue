    ...
    <div id="page-menu" ref="pagemenu" class="noselect" :class="{'page-menu-open': appState.menuOpen}">
      <div id="page-links">
        ...
        <a class="page-link-item" href="http://www.european-calculator.eu/documentation/" target="_blank" rel="noopener" :tabindex="appState.menuOpen ? 0 : -1">
          ...
          <a class="page-link-item" href="https://www.european-calculator.eu/literature-paper/" target="_blank" rel="noopener" :tabindex="appState.menuOpen ? 0 : -1">
          <span>SCIENCE</span>
          <img src="/img/open_in_new-black-18dp.svg">
        </a>
        <a class="page-link-item" href="mailto:gino.baudry@epfl.ch" :tabindex="appState.menuOpen ? 0 : -1">
          <span>FEEDBACK</span>
