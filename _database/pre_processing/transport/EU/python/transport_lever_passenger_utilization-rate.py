...
dm_uti_level4.array[idx["EU27"],idx[2050],:,idx["LDV"]] = dm_uti_level4.array[idx["EU27"],idx[2023],:,idx["LDV"]]*(1+1) # I do not put 900% here as it would blow all the results
