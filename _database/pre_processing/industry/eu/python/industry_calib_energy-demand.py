...
# file
__file__ = "/Users/echiarot/Documents/GitHub/2050-Calculators/PathwayCalc/_database/pre_processing/industry/eu/python/industry_calib_energy-demand.py"
...
def get_data(country):
    ...
    # clean df
    df["Country"] = country
    df["variable"] = ["energy-demand-excl-feedstock_" + carrier + "[TWh]" for carrier in df["energy_carrier"]]
...
# rename
dm.rename_col("energy-demand-excl-feedstock", "calib-energy-demand-excl-feedstock", "Variables")
