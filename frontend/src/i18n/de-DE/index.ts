...
export default {
  ...
  // Common UI elements
  welcome: 'Willkommen bei Transition Compass',
  ...
  notYetAvailable: 'Für diese Ansicht noch nicht verfügbar.',
  // Time periods
  ...
  // Home Page
  welcomeToTransitionCompass: 'Willkommen bei Transition Compass',
  ...
  // About Page
  aboutTitle: 'Über Transition Compass',
  ...
  theTeam: 'Das Team',
  theTeamDesc:
    'Transition Compass wird von der EPFL (École polytechnique fédérale de Lausanne) entwickelt und gepflegt und vereint Expertise in Klimawissenschaft, Energiesystemen und Datenvisualisierung.',
  startExploring: 'Erkunden beginnen',
  // Legal Page
  legalNotice: 'Rechtliche Hinweise',
  termsOfUse: 'Nutzungsbedingungen',
  termsOfUseDesc:
    'Durch den Zugriff auf und die Nutzung von Transition Compass stimmen Sie diesen Nutzungsbedingungen zu. Dieser Rechner wird zu Informations- und Forschungszwecken bereitgestellt. Obwohl wir uns um Genauigkeit bemühen, sollten die Prognosen und Modelle nicht als alleinige Grundlage für politische oder Investitionsentscheidungen verwendet werden.',
  privacyPolicy: 'Datenschutzrichtlinie',
  privacyPolicyDesc:
    'Wir respektieren Ihre Privatsphäre. Transition Compass sammelt keine persönlichen Informationen, es sei denn, Sie stellen sie ausdrücklich zur Verfügung. Alle Daten, die Sie in den Rechner eingeben, bleiben auf Ihrem Gerät und werden ohne Ihre Zustimmung nicht an unsere Server übertragen.',
  ...
  intellectualPropertyDesc:
    'Transition Compass ist Open-Source-Software. Der Code und die Methodik stehen zur Überprüfung und Mitwirkung zur Verfügung. Bitte beachten Sie unser GitHub-Repository für Lizenzdetails.',
  contact: 'Kontakt',
  contactDesc:
    'Für Fragen, Feedback oder Kooperationsmöglichkeiten kontaktieren Sie uns bitte über die Website der EPFL ENAC-Fakultät.',
  contactTestingNote:
    'Diese Version wird nur zu Test- und Evaluierungszwecken veröffentlicht. Feedback und Beiträge von Benutzern sind ausdrücklich erwünscht und tragen zur weiteren Entwicklung und Verfeinerung vor der offiziellen Veröffentlichung bei, die für Mitte 2026 geplant ist.',
  contactEmailText:
    'Für Anfragen oder Feedback wenden Sie sich bitte an Dr. Gino Baudry (EPFL) unter ',
