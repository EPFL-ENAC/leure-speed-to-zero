...
export default {
  ...
  analyzeResultsDesc: 'Visualisez les émissions, la consommation d\'énergie et les indicateurs de performance',
  // About Page
  ...
  whatWeOfferDesc: 'Notre plateforme fournit une modélisation et une analyse détaillées dans les secteurs clés :',
  buildingsSector: 'Secteur du bâtiment',
  buildingsSectorDesc: 'Modélisez le chauffage, la climatisation et les améliorations de l\'efficacité énergétique dans les bâtiments résidentiels et commerciaux',
  transportSector: 'Secteur des transports',
  transportSectorDesc: 'Analysez les transitions vers les véhicules électriques, les transports publics et la mobilité durable',
  agricultureSector: 'Secteur agricole',
  agricultureSectorDesc: 'Explorez les pratiques agricoles durables et les stratégies de réduction des émissions',
  forestrySector: 'Secteur forestier',
  forestrySectorDesc: 'Comprenez le potentiel de séquestration du carbone et la gestion durable des forêts',
  ...
  theTeam: 'L\'équipe',
  theTeamDesc: 'Speed to Zero est développé et maintenu par l\'EPFL (École polytechnique fédérale de Lausanne), réunissant une expertise en science du climat, systèmes énergétiques et visualisation de données.',
  ...
  dataUsageDesc: 'Les données sous-jacentes utilisées dans nos modèles proviennent de sources publiquement disponibles, notamment Eurostat, les agences nationales de statistiques et les institutions de recherche. Toutes les sources de données sont documentées et référencées dans l\'application.',
  ...
  intellectualPropertyDesc: 'Speed to Zero est un logiciel open source. Le code et la méthodologie sont disponibles pour examen et contribution. Veuillez consulter notre dépôt GitHub pour les détails de licence.',
  contact: 'Contact',
  contactDesc: 'Pour toute question, retour d\'information ou opportunité de collaboration, veuillez nous contacter via le site web de la faculté ENAC de l\'EPFL.',
