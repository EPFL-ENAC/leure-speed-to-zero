...
export const ExamplePathways: PathWay[] = [
  {
    ...
    values: {
      ...
      'lever_fuel-mix': 1,
      'lever_building-renovation-rate': 2,
  ...
  {
    title: 'Vaud Climat Plan v1',
    description: 'Impact of Vaud Climat Plan (first generation) on the transport sector',
    values: {
      lever_pkm: 2,
      'lever_passenger_modal-share': 2,
      lever_passenger_occupancy: 2,
      'lever_passenger_utilization-rate': 2,
      'lever_floor-intensity': 1,
      'lever_floor-area-fraction': 1,
      'lever_heatcool-behaviour': 1,
      'lever_appliance-own': 1,
  ...
  {
    title: 'Energy Law Revision (01/2025)',
    description:
      'Impact of the revision to the energy law presented in Jan. 2025 on the building sector',
    values: {
      lever_pkm: 1,
      'lever_passenger_modal-share': 1,
      lever_passenger_occupancy: 1,
      ...
      'lever_freight_utilization-rate': 1,
      'lever_fuel-mix': 1,
      'lever_building-renovation-rate': 3,
      'lever_district-heating-share': 1,
