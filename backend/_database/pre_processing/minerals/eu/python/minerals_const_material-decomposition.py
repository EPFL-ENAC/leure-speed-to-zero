...
# get data
filepath = os.path.join(current_file_directory, '../../../industry/eu/data/Literature/literature_review_material_decomposition.xlsx')
...
idx = df_agg["variable"].isin(['battery-nimh_HDV_BEV[kg/num]', 'battery-nimh_HDV_PHEV[kg/num]',
                               'battery-nimh_LDV_BEV[kg/num]', 'battery-nimh_LDV_PHEV[kg/num]',
                               'battery-pbac_HDV[kg/num]', 'battery-pbac_LDV[kg/num]'])
...
# fix material names
materials_fix = {"Aluminium" : "aluminium", "carbon paper" : "carbon-paper",
                 "concrete-and-inert" : "cement", "iron_&_steel" : "iron-and-steel",
                 "plastics-total" : "plastics", 'silver ' : 'silver', "wood" : "timber"}
