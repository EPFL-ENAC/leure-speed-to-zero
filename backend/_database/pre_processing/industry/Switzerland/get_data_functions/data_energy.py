...
def data_energy(current_working_directory):
    ...
    filepath = os.path.join(current_working_directory,  "../data/energy-demand/8788-Publikationstabellen_DE_FR_IT_2013_bis_2024.xlsx")
    df1 = pd.concat([get_energy_demand_data(filepath, mapping, key) for key in mapping.keys()])
    filepath = os.path.join(current_working_directory,  "../data/energy-demand/12231-Publikationstabellen_DE_FR_IT_1999_bis_2013.xlsx")
